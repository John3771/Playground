...
/*
 7. Выполнить задание шахмат из урока по энумам используя структуры либо классы
 */

//MARK: так совпало что я изначало использовал структуры в этом задании. Даже интересно как без них стоило реализовать ранее
